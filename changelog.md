...
## [2.2] - 2024-05-03
### Added
- support for UUID added in hw-feedback 3.1.1
- suppport for dynamic survey URL in hw-bucks-scaffold 2.5
...
### Changed
- minor CSS updates
- used new colour variables
- fixed attributes on form textarea
